...
for i in range(len(moment_text_keys)):
    ...
    axial_text_keys[i].GetProperty().SetColor(0.0, 0.0, 0.0)
    shear_text_keys[i].GetProperty().SetColor(0.0, 0.0, 0.0)
    moment_text_keys[i].GetProperty().SetColor(0.0, 0.0, 0.0)

# Change colors (all black)
undeformed_actor.GetProperty().SetColor(0.0, 0.0, 0.0)
warp_deformed_actor.GetProperty().SetColor(0.0, 0.0, 0.0)
warp_axial_actor.GetProperty().SetColor(0.0, 0.0, 0.0)
warp_shear_actor.GetProperty().SetColor(0.0, 0.0, 0.0)
warp_moment_actor.GetProperty().SetColor(0.0, 0.0, 0.0)
hedge_axial_actor.GetProperty().SetColor(0.0, 0.0, 0.0)
hedge_shear_actor.GetProperty().SetColor(0.0, 0.0, 0.0)
hedge_moment_actor.GetProperty().SetColor(0.0, 0.0, 0.0)
axial_max_actor.GetProperty().SetColor(0.0, 0.0, 0.0)
axial_end_actor.GetProperty().SetColor(0.0, 0.0, 0.0)
shear_max_actor.GetProperty().SetColor(0.0, 0.0, 0.0)
shear_end_actor.GetProperty().SetColor(0.0, 0.0, 0.0)
moment_max_actor.GetProperty().SetColor(0.0, 0.0, 0.0)
moment_end_actor.GetProperty().SetColor(0.0, 0.0, 0.0)
explain_text.GetProperty().SetColor(0.0, 0.0, 0.0)
diagram_text.GetProperty().SetColor(0.0, 0.0, 0.0)
max_disp_text.GetProperty().SetColor(0.0, 0.0, 0.0)
...
# Colors
deformed_slider_rep.GetSliderProperty().SetColor(0.0, 0.0, 0.0)
deformed_slider_rep.GetTitleProperty().SetColor(0.0, 0.0, 0.0)
deformed_slider_rep.GetLabelProperty().SetColor(0.0, 0.0, 0.0)
deformed_slider_rep.GetTubeProperty().SetColor(0.0, 0.0, 0.0)
deformed_slider_rep.GetCapProperty().SetColor(0.0, 0.0, 0.0)
# Actual widget
...
# Colors
axial_slider_rep.GetSliderProperty().SetColor(0.0, 0.0, 0.0)
axial_slider_rep.GetTitleProperty().SetColor(0.0, 0.0, 0.0)
axial_slider_rep.GetLabelProperty().SetColor(0.0, 0.0, 0.0)
axial_slider_rep.GetTubeProperty().SetColor(0.0, 0.0, 0.0)
axial_slider_rep.GetCapProperty().SetColor(0.0, 0.0, 0.0)
# Actual widget
...
# Colors
shear_slider_rep.GetSliderProperty().SetColor(0.0, 0.0, 0.0)
shear_slider_rep.GetTitleProperty().SetColor(0.0, 0.0, 0.0)
shear_slider_rep.GetLabelProperty().SetColor(0.0, 0.0, 0.0)
shear_slider_rep.GetTubeProperty().SetColor(0.0, 0.0, 0.0)
shear_slider_rep.GetCapProperty().SetColor(0.0, 0.0, 0.0)
# Actual widget
...
# Colors
moment_slider_rep.GetSliderProperty().SetColor(0.0, 0.0, 0.0)
moment_slider_rep.GetTitleProperty().SetColor(0.0, 0.0, 0.0)
moment_slider_rep.GetLabelProperty().SetColor(0.0, 0.0, 0.0)
moment_slider_rep.GetTubeProperty().SetColor(0.0, 0.0, 0.0)
moment_slider_rep.GetCapProperty().SetColor(0.0, 0.0, 0.0)
# Actual widget
